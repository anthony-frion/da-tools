...
def rollout(
    ...
    Args:
        ...
        static_inputs (State): extra inputs (e.g. bathymetry) for each instance of calling the time
                                    stepping function.
        store_every (int): if specified, indicates at which frequency the states should be stored during the rollout
