...
class State(ABC):
    ...
    def to(self, *args):
        ...
        return State(self.fields.to(*args), self.time_axis)
...
def check_time_axis(time_axis, T):
    ...
    if time_axis is None:
        ...
        assert time_axis.ndim == 1 and time_axis.nelement() == T and T > 0, f"invalid time_axis {time_axis} with shape {time_axis.shape} for size {T}"
        return time_axis
